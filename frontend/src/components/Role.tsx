export default function Role(props:any){
    return(
            <div>
            <div className={`${props.color} flex flex-col justify-center items-center rounded-3xl absolute w-[290px] h-[400px] ${props.size} hover:shadow-2xl transition delay-150 duration-250 ease-in-out -translate-y-1  hover:scale-105 hover:cursor-pointer `}>
