...
export default function Section3(){
    return(
        <div className="w-3/4 h-screen relative" id="Section3">
             ...
             <p className=" mt-12 text-gray-600 text-center cursor-default text-md">Discover a world of convenience with Aura Cut!, Whether you're a customer 
                ...
                <Link to={'/signup/shopKeeper'}><Role img="../src/Assets/barber.jpeg" color="bg-sky hover:bg-blue-400" size="ml-56 mt-16" bsize="absolute top-52 mt-4 ml-10" hsize="absolute top-44" heading="Login as Shopkeeper" body="Streamline your bookings and manage your shop efficiently."/></Link>
